    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Customer cs = new Customer(1,"Nubar","Heyderzade","nubarheyderzade@gmail.com","nubarheyderzade","123456");
            Console.WriteLine();
            Customer cs2 = new Customer(2, "Nubar2", "Heyderzade", "nubarheyderzade@gmail.com", "nubarheyderzade", "123456");
            Console.WriteLine();

            Console.WriteLine("Istifadeci daxil edin: ");
            Console.Write("Id: ");
            ...
            Customer cs3 = new Customer(id,name,surname,email,username,password);
            Console.WriteLine();
        }
    }
}
