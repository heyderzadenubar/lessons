...
namespace EduSys.Repository.Migrations
{
    ...
    [Migration("20230727065238_inital")]
            ...
            modelBuilder.Entity("EduSys.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 7, 27, 10, 52, 38, 195, DateTimeKind.Local).AddTicks(9409),
                            Name = "Computer",
                            Price = 800m,
                            Stock = 35m
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 7, 27, 10, 52, 38, 195, DateTimeKind.Local).AddTicks(9422),
                            Name = "T-shirt",
                            Price = 50m,
                            Stock = 400m
                        },
