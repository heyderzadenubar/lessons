    ...
    public partial class inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 7, 27, 10, 52, 38, 195, DateTimeKind.Local).AddTicks(9409), "Computer", 800m, 35m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 2, 2, new DateTime(2023, 7, 27, 10, 52, 38, 195, DateTimeKind.Local).AddTicks(9422), "T-shirt", 50m, 400m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 3, 3, new DateTime(2023, 7, 27, 10, 52, 38, 195, DateTimeKind.Local).AddTicks(9422), "Cat food", 25m, 1000m, null });
